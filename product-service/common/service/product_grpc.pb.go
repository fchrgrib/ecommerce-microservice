...
type ProductServiceClient interface {
	...
	AddProducts(ctx context.Context, in *ProductRequests, opts ...grpc.CallOption) (*Response, error)
	...
	DeleteById(ctx context.Context, in *ProductId, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *productServiceClient) AddProduct(ctx context.Context, in *ProductRequest, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
func (c *productServiceClient) AddProducts(ctx context.Context, in *ProductRequests, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
func (c *productServiceClient) DeleteById(ctx context.Context, in *ProductId, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
type ProductServiceServer interface {
	...
	AddProducts(context.Context, *ProductRequests) (*Response, error)
	FindOneById(context.Context, *ProductId) (*ProductRequest, error)
	FindAll(context.Context, *Empty) (*ProductRequests, error)
	DeleteById(context.Context, *ProductId) (*Response, error)
...
func (UnimplementedProductServiceServer) AddProduct(context.Context, *ProductRequest) (*Response, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddProduct not implemented")
}
func (UnimplementedProductServiceServer) AddProducts(context.Context, *ProductRequests) (*Response, error) {
...
func (UnimplementedProductServiceServer) DeleteById(context.Context, *ProductId) (*Response, error) {
